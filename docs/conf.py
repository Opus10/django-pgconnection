# -*- coding: utf-8 -*-
#
# django-pgconnection documentation build configuration file, created by
...
version = pgconnection.__version__
...
htmlhelp_basename = 'django-pgconnectiondoc'
...
latex_documents = [
    (
        master_doc,
        'django-pgconnection.tex',
        u'django-pgconnection Documentation',
        u'Opus 10',
        'manual',
    )
]
